...
Public Class rptPartywiseBalance
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptPartywiseBalance.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "INV.rptPartywiseBalance.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptPartywiseBalance
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPartywiseBalance = New rptPartywiseBalance()
        rpt.Site = Me.Site
        Return rpt
    End Function

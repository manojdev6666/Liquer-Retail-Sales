...
Public Class rptCashBankReceipt
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "INV.rptCashBankReceipt.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptCashBankReceipt
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCashBankReceipt = New rptCashBankReceipt()
        rpt.Site = Me.Site
        Return rpt
    End Function
